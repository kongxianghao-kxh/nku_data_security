...
def Repeated_Insert_Test(value, count, report_every=100):
    ...
    for i in range(1, count + 1):
        ...
        if report_every > 0 and i % report_every == 0:
            ...
            print(f"inserted {i} rows of '{value}'")
            Search('a', 'b')

if __name__ == '__main__':

    # Repeatedly insert the same plaintext to trigger splits/updates.
    Repeated_Insert_Test('apple', 500, report_every=50)
